...
#1. Send a message -> Enter a passphrase to encrypt and write a message to a shared folder/server. Add Checksum Functionality
...
mailbox_path = "../site_1/mailbox/mail.txt"
